      ...
      <React.Fragment>
        <div className="container projectsContainer py-4">
         ...
         <div className="flip-card col-6 mb-1 mb-md-4">
          ...
          <div className="col-6">
          <Slide direction="right" triggerOnce>
            <h4 className="fontPrimary mt-2">Devbox Thin Client SSH Tool</h4>
            <p className="fontSecondary">This Python script streamlines the authentication process and enables secure tunneling into a thin client by combining MAC address or IP address scanning with user credential verification. By automating device recognition and integrating user login details, the script enhances security while ensuring efficient access control in networked environments.</p>
          </Slide>
          </div>
          ...
          <Slide direction="right" triggerOnce>
            ...
            <div className="col-12">
              <h4 className="fontPrimary mt-2 text-center">Devbox Thin Client SSH Tool</h4>
              <p className="fontSecondary text-center">This Python script streamlines the authentication process and enables secure tunneling into a thin client by combining MAC address or IP address scanning with user credential verification. By automating device recognition and integrating user login details, the script enhances security while ensuring efficient access control in networked environments.</p>
            </div>
          </Slide>
